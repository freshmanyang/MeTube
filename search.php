...
<!--        <div id="advanced-search-container" >-->
            <div id="first_row">
             ...
             <div class="btn-group">
                <button type="button" id="category" class="btn btn-outline-dark dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Category
                </button>
            ...
            Min:<input type="number" id="file_size_min" name="file_size_min" placeholder="0" min="0" max="499" SIZE="10">
            Max:<input type="number" id="file_size_max" name="file_size_max" placeholder="500" min="1" max="500" SIZE="10">
            </P><P>
            ...
            Max:<input type="number" id="duration_max" name="duration_max" placeholder="120"  min="1" max="120" SIZE="10">
            </P><P>
